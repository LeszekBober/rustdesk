...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Right click to select tabs", "Kliknij prawym przyciskiem myszy, aby wybrać zakładki"),
        ("Skipped", "Pominięto"),
        ("Add to Address Book", "Dodaj do Książki Adresowej"),
        ("Group", "Grupy"),
        ("Search", "Szukaj"),
        ("Closed manually by the web console", "Zamknięte ręcznie przez konsolę internetową"),
        ("Local keyboard type", "Lokalny typ klawiatury"),
        ("Select local keyboard type", "Wybierz typ klawiatury lokalnej"),
    ].iter().cloned().collect();
}
